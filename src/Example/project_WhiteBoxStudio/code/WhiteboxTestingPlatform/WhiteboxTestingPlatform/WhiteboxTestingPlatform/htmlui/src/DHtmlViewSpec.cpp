...
BOOL CDHtmlViewSpec::CallJScript(const CString & strFunc,const CString & strArg1,CComVariant* pVarResult)
{
...
BOOL CDHtmlViewSpec::CallJScript(const CString & strFunc,const CString & strArg1,const CString & strArg2,CComVariant* pVarResult)
{
	CStringArray paramArray;
	paramArray.Add(strArg1);
...
BOOL CDHtmlViewSpec::CallJScript(const CString & strFunc,const CString & strArg1,const CString & strArg2,const CString & strArg3,CComVariant* pVarResult)
{
	CStringArray paramArray;
	paramArray.Add(strArg1);
	paramArray.Add(strArg2);
...
#include "dispeX.h"
BOOL CDHtmlViewSpec::CallJScript(const CString & strFunc, const CStringArray& paramArray, CComVariant* pVarResult)
{
	CComPtr<IDispatch> spScript;
	CComPtr<IDispatchEx> spScript1;
	...
	hr = spScript->QueryInterface(IID_IDispatchEx, (void**)&spScript1);
	//spWindow->get_Script(&spScript);
	/*
	...
	CComBSTR bstrMember(strFunc);
	DISPID dispid = NULL;
	/*hr = spWindow->GetIDsOfNames(IID_NULL,&bstrMember,1,
		LOCALE_SYSTEM_DEFAULT,&dispid);*/
	hr = spScript1->GetDispID( bstrMember, fdexNameImplicit, &dispid );
	...
	hr = spScript1->Invoke(dispid,IID_NULL,0,
...
BOOL CDHtmlViewSpec::CreateFromStatic(UINT nID, CWnd* pParent)
{
	CStatic wndStatic;
...
BOOL CDHtmlViewSpec::PreTranslateMessage(MSG* pMsg)
{
	...
	{
		OutputDebugString(_T("Function key ignored\r\n"));
		return true;
	}
	...
	{
		//Ctrl-N
		OutputDebugString(_T("Ctrl-N ignored\r\n"));
		return true;
	}
	//ban printing
	...
	{
		//Ctrl-P
		OutputDebugString(_T("Ctrl-P ignored\r\n"));
		return true;
	}
	...
	{
		//Ctrl-D
		OutputDebugString(_T("Ctrl-D ignored\r\n"));
		return true;
	}
	...
	{
		//Atl-Left
		OutputDebugString(_T("Atl-Left ignored\r\n"));
		return true;
	}
	...
	{
		//Atl-Right
		OutputDebugString(_T("Atl-Right ignored\r\n"));
		return true;
	}
