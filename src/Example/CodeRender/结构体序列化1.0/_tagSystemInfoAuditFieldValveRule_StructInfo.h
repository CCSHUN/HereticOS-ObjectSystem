...
class Serialize__tagSystemInfoAuditFieldValveRule : public Serialize_StructBase<_tagSystemInfoAuditFieldValveRule,Serialize__tagSystemInfoAuditFieldValveRule>
{
	public:
	typedef _tagSystemInfoAuditFieldValveRule _MyObjectType;
	...
	Serialize_BaseObject<__int64> FiledValve;
 	...
 	Serialize__tagSystemInfoAuditFieldValveRule(){};
	~Serialize__tagSystemInfoAuditFieldValveRule(){};
 	_Myt& operator=(_tagSystemInfoAuditFieldValveRule & _X)
	{
		SetData(_X);
		return *this;
	}
 	...
 	BOOL Construct(StorageObjectInterface * pOutObject)
	{
 	...
 	void SetData(_tagSystemInfoAuditFieldValveRule & _X)
	{
		RuleID=_X.RuleID; 
	...
	{
		pStorageObject->PushNodeCtlBegin(_T("_tagSystemInfoAuditFieldValveRule"),this);
		...
		pStorageObject->PushNodeCtlEnd(_T("_tagSystemInfoAuditFieldValveRule"),this);
		return TRUE;
	}
